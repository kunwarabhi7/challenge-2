...
const Navbar = () => {
  ...
  return (
    <div className='flex basis  m-8  w-full'>
      <div className='basis-1/6 h-12 w-12'>
...
Blog                 </button>
    ...
    {/* Mobile  */}
    <div className='flex  md:hidden w-10 h-10 ml-48 md:ml-36'>
      <img src={IconMenu} onClick={toggleNaVBar} alt="" />
 ...
 Blog                 </button>
     ...
     <h1 className='text-xl mt-2 ml-28 font-medium text-gray-400 '>Careers</h1>
     <h1 className='text-xl mt-2 ml-28 font-medium text-gray-400 hover:text-gray-800 cursor-pointer'>About</h1>
     </div>
